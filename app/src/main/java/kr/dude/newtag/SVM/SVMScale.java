...
public class SVMScale
{
    ...
    private void run(String []argv) throws IOException
    {
        ...
        System.out.println(" ====> DATA_FILENAME " + data_filename);
...
//        }
		...
		/* pass 3: scale */
        PrintWriter pw = new PrintWriter(save_filename);
...
//            System.out.println(" ===========> READLINE " + line);
            ...
            /* SVM WRITE */
            String outputTarget = output_target(target);
            pw.print(outputTarget);
...
//                System.out.println(" index : " + index + " value : " + value);
                for (i = next_index; i<index; i++) {
                    ...
                    /* SVM WRITE */
                    String strOutput = output(i, 0);
                    pw.print(strOutput);
                }

                /* SVM WRITE */
                String strOutput = output(index, value);
//                System.out.println(" =====> strOutput " + strOutput);
    ...
    public static void scale(String nonScaledFilePath, String scaledFilePath) throws IOException
    {
        SVMScale s = new SVMScale();

        String[] argv = {
          "-s", scaledFilePath, nonScaledFilePath
        };
